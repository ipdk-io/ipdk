...
class PciDeviceTests(TestCase):
    ...
    def test_get_device_by_pci_address(self):
        ...
        dev_path = get_virtio_blk_path_by_pci_address(PciAddress("0000:00:04.0"))
    ...
    def test_corner_function_value(self):
        ...
        self.fs.create_dir(path)
        self.fs.create_file("/dev/vda")
        dev_path = get_virtio_blk_path_by_pci_address(PciAddress("0000:00:04.7"))
        self.assertEqual(dev_path, "/dev/vda")
    ...
    def test_multiple_domains(self):
        ...
        dev_path = get_virtio_blk_path_by_pci_address(PciAddress("0001:00:04.0"))
    ...
    def test_multiple_buses(self):
        ...
        dev_path = get_virtio_blk_path_by_pci_address(PciAddress("0000:01:04.0"))
        self.assertEqual(dev_path, "/dev/vdb")
    ...
    def test_multiple_devices(self):
        ...
        dev_path = get_virtio_blk_path_by_pci_address(PciAddress("0000:00:01.0"))
        self.assertEqual(dev_path, "/dev/vdb")
    ...
    def test_multiple_functions(self):
        ...
        dev_path = get_virtio_blk_path_by_pci_address(PciAddress("0000:00:04.1"))
        self.assertEqual(dev_path, "/dev/vdb")
    ...
    def test_no_block_device_exists(self):
        ...
        with self.assertRaises(FailedPciDeviceDetection) as ex:
            get_virtio_blk_path_by_pci_address(PciAddress("0000:00:00.0"))
    ...
    def test_multiple_block_devices_in_virtio_dir(self):
        ...
        self.fs.create_file("/dev/vdb")
        with self.assertRaises(FailedPciDeviceDetection) as ex:
            get_virtio_blk_path_by_pci_address(PciAddress("0000:00:04.0"))

    def test_no_block_devices(self):
        path = "/sys/devices/pci0000:00/0000:00:04.0"
        self.fs.create_dir(path)
        with self.assertRaises(FailedPciDeviceDetection) as ex:
            get_virtio_blk_path_by_pci_address(PciAddress("0000:00:04.0"))

    def test_no_device_in_virtio_block(self):
        path = "/sys/devices/pci0000:00/0000:00:04.0/virtio0/block"
        self.fs.create_dir(path)
        with self.assertRaises(FailedPciDeviceDetection) as ex:
            get_virtio_blk_path_by_pci_address(PciAddress("0000:00:04.0"))
    ...
    def test_get_device_by_pci_address_on_pci_bridge(self):
        ...
        self.fs.create_dir(path)
        self.fs.create_file("/dev/vda")
        dev_path = get_virtio_blk_path_by_pci_address(PciAddress("0000:01:01.0"))
        self.assertEqual(dev_path, "/dev/vda")
